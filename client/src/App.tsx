...
import ConsequencesPage from './pages/consequences/ConsequencesPage';
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/risks/:id" element={<ProtectedRoute resource="risks"><RiskDetailPage /></ProtectedRoute>} />
      ...
      <Route path="/consequences" element={<ProtectedRoute resource="consequences"><ConsequencesPage /></ProtectedRoute>} />
      <Route path="/thresholds" element={<ProtectedRoute resource="thresholds"><ThresholdsPage /></ProtectedRoute>} />
