...
const columns = [
  ...
  { title: <FieldLabelWithHelp fieldKey="risks.qualitative_score" label="Keyfiyyət skoru" />, dataIndex: 'qualitative_score', key: 'qualitative_score', width: 130 },
  { title: <FieldLabelWithHelp fieldKey="risks.treatment_option" label="Emal" />, dataIndex: 'treatment_option', key: 'treatment_option', width: 140 },
  {
    title: 'Status', dataIndex: 'status', key: 'status', width: 110,
    render: (v: string) => <Tag color={v === 'açıq' ? 'red' : v === 'bağlı' ? 'green' : 'processing'}>{v}</Tag>,
  },
  { title: <FieldLabelWithHelp fieldKey="risks.residual_risk_score" label="Qalıq risk" />, dataIndex: 'residual_risk_score', key: 'residual_risk_score', width: 110 },
];
